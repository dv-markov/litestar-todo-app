...
# a value for x when creating a class instance will share the same copy of x. Because Data Classes just use normal
# Python class creation they also share this problem. There is no general way for Data Classes to detect this condition.
# Instead, Data Classes will raise a TypeError if it detects a default parameter of type list, dict, or set.
# This is a partial solution, but it does protect against many common errors. See Automatically support mutable default
# values in the Rejected Ideas section for more details.
